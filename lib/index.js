...
class DMCWechatWrappers {
  constructor(options, modules) {
    ...
    this.options = merge(__privateGet(this, _options), options), this.urlSearchParams = new URLSearchParams(this.options.urlSearch), this.checkENV(), this.installModules(modules);
  }
  get isWechat() {
    return isWeiXin();
  }
