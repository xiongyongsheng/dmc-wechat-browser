function toAuth() {
  ...
  String(state) || (state = this.urlSearchParams.get("state") || "STATE"), location.replace(
    `${this.options.oauth2}?appid=${this.isQYWechat ? this.options.corpId : this.options.appId}&redirect_uri=${encodeURIComponent(
